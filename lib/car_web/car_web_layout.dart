...
/// Layout ويب لمعارض السيارات وتجار السيارات — Sidebar و Header
class CarWebLayout extends StatefulWidget {
  final Widget child;
  final String title;
  ...
  @override
  State<CarWebLayout> createState() => _CarWebLayoutState();
}

class _CarWebLayoutState extends State<CarWebLayout> {
      ...
      child: Material(
        ...
        child: InkWell(
          onTap: () {
            ...
            Future.microtask(() {
              if (context.mounted) _navigateToRoute(context, route);
            });
          },
          borderRadius: BorderRadius.circular(8),
