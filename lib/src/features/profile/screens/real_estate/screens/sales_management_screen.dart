...
class _RealEstateSalesManagementScreenState extends State<RealEstateSalesManagementScreen> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final viewModel = Provider.of<SalesManagementViewModel>(context, listen: false);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          Consumer<SalesManagementViewModel>(
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () {
          final viewModel = Provider.of<SalesManagementViewModel>(context, listen: false);
          _showAddSaleDialog(context, viewModel);
        },
        backgroundColor: AppColors.accent,
            ...
            onPressed: () {
              if (formKey.currentState?.validate() ?? false) {
                ...
                if (selectedProperty != null && 
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text('تمت إضافة عملية البيع بنجاح'),
            ...
            _buildExportButton(
              ...
              () async {
                ...
                if (context.mounted) {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text('تم تصدير التقرير بصيغة Excel'),
                      backgroundColor: AppColors.success,
                    ),
                  );
                }
